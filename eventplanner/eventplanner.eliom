...
let%shared main_service_handler userid_o () () =
  Eventplanner_container.page userid_o (
    [
...
let () =
  ...
  Eventplanner_base.App.register
    Eba_services.main_service
    (Eventplanner_page.Opt.connected_page main_service_handler);

  Eventplanner_base.App.register
    Eventplanner_services.about_service
    (Eventplanner_page.Opt.connected_page about_handler)
...
let%client init_client_app () =
  ...
  set_client_fun ~app ~service:Eventplanner_services.about_service
    (Eventplanner_page.Opt.connected_page about_handler);
